...
//    private final Drawable mShadowDrawable;
     ...
     * The size of the overhang in pixels.
     */
    private float mPanelHeightPercent = -1;
...
//            mShadowDrawable = null;
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mPanelHeightPercent = ta.getFloat(R.styleable.SlidingUpPanelLayout_panelHeighPercent, -1);
...
//        }
        ...
        if(mPanelHeightPercent != -1){
            setPanelHeight((int) (heightSize*mPanelHeightPercent));
        }
