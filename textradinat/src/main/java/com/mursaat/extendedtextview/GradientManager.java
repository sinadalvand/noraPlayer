...
public class GradientManager {
    ...
    /**
     * Original color for returning after stop
     */
    private int orginalColor = Color.WHITE;
    ...
    private void initFromAttrsValues(AttributeSet attrs) {
        ...
        orginalColor = typedArray.getColor(5, Color.WHITE);
    ...
    public void stopGradient() {
        synchronized (this) {
            if (scheduledFuture != null) {
                ...
                textView.getPaint().setShader(new LinearGradient(0, 0, textView.getWidth(), textView.getHeight(), orginalColor, orginalColor, Shader.TileMode.CLAMP));
                textView.setTextColor(orginalColor);
